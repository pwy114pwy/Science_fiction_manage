  ...
  <el-drawer v-model="drawer2" :direction="direction">
    <template #default>
      <el-form :model="form" style="max-width: 600px">
        ...
        <!-- 能力 -->
        <el-form-item style="display: flex;" label="角色能力：">
            <p v-for="(item, index) in form.AbilityList">{{ item.key }}:
              <el-input style="display: inline-block;" v-model="item.value" placeholder=""  clearable />
            </p>
