<template>
  ...
  <el-drawer v-model="drawer2" :direction="direction" title="">
    <el-form :model="newUserForm" :rules="rules" ref="userFormRef" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item>
        <el-button v-show="@isupdate" type="primary" @click="submitForm(userFormRef)">提交</el-button>
        <el-button v-show="isupdate" type="primary" @click="submitForm(userFormRef)">更新</el-button>
