    ...
    <el-container>
      ...
      <el-main>
        <el-table :data="filterTableData" style="width: 100%">
          ...
          <el-table-column label="世界观biaot" prop="Illustrated_Name" />
          <el-table-column label="世界观描述">
            <template #default="{ row }">
              {{ row.Event_Description.slice(0, 30) }}
            </template>
          </el-table-column>
          <el-table-column label="事件时间" prop="Event_Time" />
          <el-table-column label="事件评分" prop="Event_Value" />
      ...
      <template #default>
        <el-form :model="form" style="max-width: 600px">
          ...
          <el-form-item label="事件描述:">
            <el-input v-model="form.Event_Description" style="width: 240px" :rows="2" type="textarea" placeholder="Please input" />
          </el-form-item>
          <!-- 事件时间 -->
          <el-form-item label="事件时间(年):">
            <el-input v-model="form.Event_Time" />
          </el-form-item>
          <!-- 事件评分 -->
          <el-form-item label="事件评分:">
            <el-input placeholder="(0-10)" v-model="form.Event_Value" />
          </el-form-item>
          <el-form-item>
