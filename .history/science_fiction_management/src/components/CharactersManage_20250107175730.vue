    ...
    <template #default>
      ...
      <el-form :model="form" style="max-width: 600px">
        ...
        <el-form-item label="角色简介:">
          <el-input v-model="form.Role_Introduction" style="width: 240px" :rows="2" type="textarea" placeholder="Please input" />
        </el-form-item>
        <!-- 经典语录 -->
        <el-form-item label="经典语录:">
          <el-input v-model="form.Classic_Quotes" style="width: 240px" :rows="2" type="textarea" placeholder="Please input" />
        </el-form-item>
        <!-- 标签 -->
...
function confirm_contribute_Edit() {
  ...
  for (const key in form.ContributeList) {
    if (form.ContributeList[key] == dialogContent_org.value&&form.ContributeList[key]!="") {
