    ...
    <div class="hotbook">
      <div class="common-layout">
        <el-container>
          ...
          <el-main>
            <div id="main1" style="width: 400px;height:310px;"></div>
          </el-main>
        </el-container>
      </div>
    </div>
    <div class="browser">
      <div class="common-layout">
        <el-container>
          ...
          <el-main>
            <div id="main2" style="width: 400px;height:310px;"></div>
          </el-main>
        </el-container>
      </div>
    </div>
...
onMounted(async () => {
  ...
  if (chartDom2.value) {
    ...
    const option = getEChartsOption2(browser_data_x.value,browser_data_y.value)
    if (myChart2) {
