    ...
    <el-container>
      ...
      <el-main>
        <el-table :data="filterTableData" style="width: 100%">
          ...
          <el-table-column label="事件描述" prop="From_Name" />
          <el-table-column label="事件名称" prop="To_Name" />
          <el-table-column label="事件评分" prop="Relation_Type" />
...
import { getEvents } from "@/api/getRelationships"
...
const handleEdit = (index: number, row) => {
  ...
  // 确保ID也被复制过来
  form.Relationship_ID = row.Relationship_ID;
  // 打开抽屉
  drawer2.value = true;
};
