    ...
    <el-container>
      ...
      <el-main>
        <el-table :data="filterTableData" style="width: 100%">
          ...
          <el-table-column label="图鉴名称" prop="Book_Name" />
          <el-table-column label="角色1" prop="Tag" />
          <el-table-column label="角色2" prop="Topic" />
          <el-table-column label="角色关系" prop="Author" />
...
const handleEdit = (index: number, row) => {
  ...
  // 确保ID也被复制过来
  form.Relationship_ID = row.Book_ID; // 假设你的图书对象有一个id属性标识它是否是一个已有记录
  // 打开抽屉
  drawer2.value = true;
};
