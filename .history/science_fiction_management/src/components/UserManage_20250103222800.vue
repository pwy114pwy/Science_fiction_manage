  ...
  <el-container>
    <el-header>
      <el-row :gutter="20">
        ...
        <el-col :span="3">
          <el-button @click="add_btn = true" type="primary">
  ...
  <el-drawer v-model="drawer2" :direction="direction" title="">
    <el-form :model="newUserForm" :rules="rules" ref="userFormRef" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="密码" prop="password">
        <el-input v-show="!newUserForm.username" v-model="newUserForm.password" type="password"></el-input>
        <el-input v-show="newUserForm.username" v-model="newUserForm.password" disabled type="password"></el-input>
      </el-form-item>
