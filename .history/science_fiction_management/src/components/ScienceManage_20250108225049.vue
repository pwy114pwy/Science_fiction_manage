  ...
  <el-container>
    ...
    <el-main>
      <el-table :data="filterTableData" style="width: 100%">
        ...
        <el-table-column label="科技名称" prop="Role_Name" />
        <el-table-column #default="{ row }" label="科技miao">
        ...
        <el-table-column #default="{ row }" label="角色能力">
          <span v-show="row.AbilityList[0].value" v-for="(item, index) in row.AbilityList">{{ item.key }}：{{ item.value
            }}</span>...
    ...
    <template #default>
      ...
      <el-form :model="form" style="max-width: 600px">
        ...
        <el-form-item label="角色简介:">
          <el-input v-model="form.Role_Introduction" style="width: 240px" :rows="2" type="textarea" placeholder="输入模版：90(重要程度0-100)|三体入侵(标题)|三体人即将入侵地球...(正文)" />
        </el-form-item>
        <!-- 经典语录 -->
        <el-form-item label="经典语录:">
          <el-input v-model="form.Classic_Quotes" style="width: 240px" :rows="2" type="textarea" placeholder="使用'|'间隔每一条语录" />
        </el-form-item>
        <!-- 标签 -->
