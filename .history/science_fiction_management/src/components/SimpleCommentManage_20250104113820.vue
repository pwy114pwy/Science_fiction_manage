<template>
  <div class="common-layout">
    <el-container>
      ...
      <el-main>
        <el-table :data="comment_options" style="width: 100%">
        <el-table-column type="index" />
        <el-table-column label="shuji" prop="Book_ID" />
        <el-table-column label="密码" prop="Book_Name" />
        <el-table-column label="昵称" prop="Comment_Content" />
        <el-table-column label="邮箱" prop="Comment_Time" />
        <el-table-column label="邮箱" prop="Comment_User_Name" />
        <el-table-column label="邮箱" prop="Comment_User_NickName" />
