    ...
    <div class="wordCloud">
      <div class="common-layout">
        <el-container>
          ...
          <el-main>
            <div id="main5" style="width: 100%;height:280px;"></div>
          </el-main>
        </el-container>
      </div>
    </div>
...
onMounted(async () => {
  ...
  word_data.value = getWorddata(res5)
  ...
  if (chartDom5.value) {
    ...
    const option5 = getEChartsOption5(topic_data.value)
    if (myChart5) {
