    ...
    children: [
      ...
      },
      {
        ...
        children:[
          ...
          {
            path: 'EventManage',
            component: () => import('@/components/EventManage.vue'),
            name: "事件管理",
            meta: {
              title: '事件管理',
              hidden: true,
          ...
          {
            path: 'WorldviewManage',
            component: () => import('@/components/WorldviewManage.vue'),
            name: "世界观管理",
            meta: {
              title: '世界观管理',
              hidden: true,
          ...
          {
            path: 'WorldviewManage',
            component: () => import('@/components/ScienceManage.vue'),
            name: "科技观管理",
            meta: {
              title: '科技观管理',
              hidden: true,
